...
This parameterized report shows graphs of the COVID-19 cases and deaths in Europe.
The adjustable parameters are `country`, `year`, `period_start` and `period_end`.

```{r setup_3, warning=FALSE, message=FALSE}
